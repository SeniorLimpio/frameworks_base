...
import com.android.systemui.statusbar.SignalClusterTextView; //FixedEM
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    CarrierLabel vCarrierLabel;
    //LinearLayout mSignalClusterText; //FixedEM
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        vCarrierLabel = (CarrierLabel)mStatusBarView.findViewById(R.id.status_bar_carrier_label);
        //mSignalClusterText = (LinearLayout)mStatusBarView.findViewById(R.id.mobile_signal_text_combo); //FixedEM
    ...
    Animator mScrollViewAnim, mFlipSettingsViewAnim, mNotificationButtonAnim, mSettingsButtonAnim, mHaloButtonAnim, mClearButtonAnim, mRibbonViewAnim, mBrightnessViewAnim, mHoverButtonAnim;
    ...
    private void onTextColorChange(int color) {
        ...
        if (vCarrierLabel != null) {
            vCarrierLabel.updateSettings(color);
        }
      /*if (mSignalClusterText != null) {
            mSignalClusterText.updateSettings(color);
        }*/
    }

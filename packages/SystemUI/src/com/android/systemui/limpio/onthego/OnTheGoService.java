...
package com.android.systemui.limpio.onthego;
...
import com.android.internal.util.limpio.ShakeDetector;
...
public class OnTheGoService extends Service implements ShakeDetector.Listener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null || !LimpioUtils.hasCamera(this)) {
            stopSelf();
    ...
    private void getCameraInstance(int type) throws RuntimeException, IOException {
        ...
        if (!LimpioUtils.hasFrontCamera(this)) {
            mCamera = Camera.open();
            return;
        }
